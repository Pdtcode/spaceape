...
export const Navbar = () => {
  ...
  return (
    <HeroUINavbar
      className={`${fontPassionOne.variable} font-passion-one py-1 text-white bg-sablue`}
    ...
    >
      <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <NextLink
            className="flex justify-start ml-4 items-center gap-1"
            href="/"
          >
      ...
      <NavbarMenu className="font-passion-one">
        <div className="mx-4 mt-2 flex flex-col gap-2">
          ...
          <div className="mt-8 pt-4 border-t border-gray-200">
            <a
              className="flex items-center gap-3 text-sablue hover:text-blue-600 transition-colors"
